  ...
  return (
    <div className="flex justify-center items-center overflow-y-auto">
      <div className="flex flex-col md:flex-row business-info-container max-w-2xl">
        <div className="md:w-1/2 text-left p-4 bg-white rounded-md shadow-md shadow-zap-orange/150 overflow-x-auto">
        ...
        <div className="md:w-1/2 shadow-md shadow-zap-orange/150 mt-4 md:mt-0 md:ml-4">
          <img
